      ...
      <div className="space-y-6">
        {CERTS.map((cert) => (
          ...
          >
            ...
            <button className="w-full py-4 rounded-2xl bg-white/5 border border-white/10 font-black text-white flex items-center justify-center gap-2 hover:bg-white/10 transition">
